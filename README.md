# G01 - Painel de Grupos de Clientes

Sistema de monitoramento e gerenciamento de grupos de WhatsApp para clientes da G01.
...
### Cores Principais
- **G01 Primary**: `#2463F5` - Cor primária da marca
- **G01 Dark**: `#1A1A1A` - Texto principal
- **G01 Gray**: `#6B7280` - Texto secundário
...
Desenvolvido para **G01** com foco em monitoramento eficiente de grupos de clientes WhatsApp.
