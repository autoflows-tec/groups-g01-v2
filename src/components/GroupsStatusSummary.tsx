...
export const GroupsStatusSummary = ({ statusSummary, activeFilter, onFilterChange }: GroupsStatusSummaryProps) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      ...
      <Card 
        className={cn(
          "bg-white dark:bg-g01-dark-card border-2 shadow-sm cursor-pointer transition-all duration-200 hover:shadow-md",
      ...
      >
        <CardContent className="p-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm font-inter text-g01-gray-medium dark:text-gray-300">Grupos Estáveis</p>
      ...
      >
        <CardContent className="p-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm font-inter text-g01-gray-medium dark:text-gray-300">Grupos em Alerta</p>
      ...
      >
        <CardContent className="p-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm font-inter text-g01-gray-medium dark:text-gray-300">Grupos Críticos</p>
