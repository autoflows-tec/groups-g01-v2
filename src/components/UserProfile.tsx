    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" className="relative h-10 w-10 rounded-full">
          <Avatar className="h-10 w-10 border-2 border-g01-primary">
            <AvatarFallback className="bg-g01-primary text-white font-inter font-medium">
              {getUserInitials()}
            </AvatarFallback>
          </Avatar>
        </Button>
            ...
            <form onSubmit={handleUpdateProfile} className="space-y-4">
              ...
              <div className="flex justify-end space-x-2 pt-4">
                ...
                <Button
                  type="submit"
                  disabled={loading}
                  className="bg-g01-primary hover:bg-g01-primary-hover"
                >
                  {loading ? (
                    <>
