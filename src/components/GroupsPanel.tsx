...
const GroupsPanel = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-g01-dark-bg">
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center space-y-4">
            <G01Logo className="h-16 w-auto mx-auto animate-pulse" />
            <div className="flex items-center space-x-2 text-g01-dark dark:text-white">
              <Loader2 className="h-5 w-5 animate-spin text-g01-primary" />
      ...
      <div className="container mx-auto px-4 py-8">
        {error ? (
          <div className="text-center py-12">
            <div className="bg-white dark:bg-g01-dark-card rounded-lg border-2 border-g01-primary p-8 max-w-md mx-auto shadow-sm">
              <AlertCircle className="h-12 w-12 text-red-500 mx-auto mb-4" />
              <h3 className="text-xl font-poppins font-semibold text-g01-dark dark:text-white mb-2">
                Erro ao carregar dados
              </h3>
              <p className="text-g01-gray-medium dark:text-gray-300 font-inter mb-4">{error}</p>
              <Button
                onClick={handleRefresh}
                className="bg-g01-primary hover:bg-g01-primary-hover text-white font-inter font-medium"
              >
                Tentar novamente
              </Button>
            </div>
          ...
          <div className="text-center py-12">
            <div className="bg-white dark:bg-g01-dark-card rounded-lg border-2 border-gray-200 dark:border-gray-600 p-8 max-w-md mx-auto shadow-sm">
              <G01Logo className="h-16 w-auto mx-auto mb-4 opacity-50" />
              <h3 className="text-xl font-poppins font-semibold text-g01-dark dark:text-white mb-2">
                Nenhum grupo encontrado
              </h3>
              <p className="text-g01-gray-medium dark:text-gray-300 font-inter">
          ...
          <>
            ...
            {filteredGroups.length === 0 ? (
              <div className="text-center py-12">
                <div className="bg-white dark:bg-g01-dark-card rounded-lg border-2 border-gray-200 dark:border-gray-600 p-8 max-w-md mx-auto shadow-sm">
                  <Search className="h-16 w-16 mx-auto mb-4 text-g01-gray-medium dark:text-gray-400" />
                  <h3 className="text-xl font-poppins font-semibold text-g01-dark dark:text-white mb-2">
                    Nenhum grupo encontrado
                  </h3>
                  <p className="text-g01-gray-medium dark:text-gray-300 font-inter">
              ...
              <>
                {/* Groups Table */}
                <Card className="bg-white dark:bg-g01-dark-card border-2 border-gray-200 dark:border-gray-600 shadow-sm">
                  <CardHeader className="border-b-2 border-g01-primary">
                    <CardTitle className="text-g01-dark dark:text-white font-poppins">
                      Lista de Grupos
                      {(searchTerm || managementFilters.squad || managementFilters.head || managementFilters.gestor) && (
                        <span className="text-sm font-normal text-g01-gray-medium dark:text-gray-300 ml-2 font-inter">
                          - Filtros: 
