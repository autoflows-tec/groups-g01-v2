...
export const GroupsTable = ({ groups, onUpdateGroup, onClearStatus }: GroupsTableProps) => {
  ...
  return (
    <div className="overflow-x-auto">
      <Table>
        <TableHeader>
          <TableRow className="border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-g01-dark-card/50">
            <TableHead className="text-g01-dark dark:text-white font-poppins font-semibold">Nome do Grupo</TableHead>
            <TableHead className="text-g01-dark dark:text-white font-poppins font-semibold">Squad</TableHead>
            <TableHead className="text-g01-dark dark:text-white font-poppins font-semibold">Head</TableHead>
            <TableHead className="text-g01-dark dark:text-white font-poppins font-semibold">Gestor</TableHead>
            <TableHead className="text-g01-dark dark:text-white font-poppins font-semibold">Data de Última Atualização</TableHead>
            <TableHead className="text-g01-dark dark:text-white font-poppins font-semibold">Status do Grupo</TableHead>
            <TableHead className="text-g01-dark dark:text-white font-poppins font-semibold">Situação</TableHead>
            <TableHead className="text-g01-dark dark:text-white font-poppins font-semibold text-center w-24">Status</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {groups.map((group) => {
            ...
            return (
              <TableRow key={group.id} className="border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-g01-dark-card/50">
                <TableCell className="text-g01-dark dark:text-white font-inter font-medium">
                ...
                <TableCell className="text-g01-gray-medium dark:text-gray-300 font-inter">
