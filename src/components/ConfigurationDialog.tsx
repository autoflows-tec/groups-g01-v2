...
export const ConfigurationDialog = ({ open, onOpenChange, type }: ConfigurationDialogProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px] bg-white dark:bg-g01-dark-card border-gray-200 dark:border-gray-600">
        <DialogHeader>
          <DialogTitle className="text-g01-dark dark:text-white font-poppins">
            {getTitle()}
          </DialogTitle>
          <DialogDescription className="text-g01-gray-medium dark:text-gray-300 font-inter">
            {getDescription()}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 max-h-[400px] overflow-y-auto">
          {items.map((item) => (
            <div 
              key={item.id} 
              className="flex items-center justify-between p-3 border border-gray-200 dark:border-gray-600 rounded-md bg-gray-50 dark:bg-g01-dark-bg"
            >
              {editingId === item.id ? (
                <div className="flex items-center space-x-2 flex-1">
                  <Input
                    ...
                    className="flex-1 text-g01-dark dark:text-white bg-white dark:bg-g01-dark-card border-gray-300 dark:border-gray-600"
                    onKeyDown={(e) => {
                ...
                <>
                  <div className="flex-1">
                    <span className="text-g01-dark dark:text-white font-inter font-medium">
                      {type === 'groups' 
                  ...
                  <div className="flex items-center space-x-2">
                    {type !== 'groups' && (
                      <Button 
                        ...
                        className="border-gray-300 dark:border-gray-600 text-g01-dark dark:text-white hover:bg-gray-100 dark:hover:bg-g01-dark-card"
                      >
          ...
          {isAdding ? (
            type === 'groups' ? (
              <div className="space-y-4 p-4 border border-gray-200 dark:border-gray-600 rounded-md bg-blue-50 dark:bg-blue-900/20">
                <div className="space-y-2">
                  <Label className="text-g01-dark dark:text-white font-inter font-medium">
            ...
            <Button
              ...
              disabled={hook.loading || editingId !== null}
              className="w-full bg-g01-primary hover:bg-g01-primary-hover text-white border-0 rounded-md shadow-sm font-inter font-medium"
            >
