...
export const ConfigurationMenu = ({ onConfigurationSelect }: ConfigurationMenuProps) => {
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent 
        align="end" 
        className="bg-white dark:bg-g01-dark-card border-gray-200 dark:border-gray-600"
      >
        <DropdownMenuItem 
          onClick={() => onConfigurationSelect('squads')}
          className="text-g01-dark dark:text-white hover:bg-gray-100 dark:hover:bg-g01-dark-bg cursor-pointer"
        >
          Gerenciar Squads
        </DropdownMenuItem>
        <DropdownMenuItem 
